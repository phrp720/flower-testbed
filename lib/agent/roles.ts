...
export const ROLES: Record<RoleName, RoleDefinition> = {
  ...
  analyst: {
    ...
    instructions: [
      ...
      '',
      'For what a model actually learned -- which classes it confuses, what the picture',
      'on the experiment page is showing -- use describe_model_view. It carries the',
      'per-class breakdown the digest does not.',
      '',
